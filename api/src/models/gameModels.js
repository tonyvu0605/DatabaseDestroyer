...
export const fetchHighScoreGame = async () => {
  const getLikesSQL = `SELECT hometeam.team_id as home_team_id, hometeam.team_name as home_team_name, awayteam.team_id as away_team_id, awayteam.team_name as away_team_name, Games.pts_home, Games.pts_away, (Games.pts_home + Games.pts_away) as total_points
                         FROM Games
